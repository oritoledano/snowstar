...
## Corpus Check
- 62 files · ~346,149 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 785 nodes · 1852 edges · 46 communities (44 shown, 2 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31716b8b`
...
### Community 44 - "members.js"
Cohesion: 0.53
Nodes (4): deleteMember(), json(), memberDetail(), updateMember()

### Community 45 - "Four services section"
Cohesion: 0.40
