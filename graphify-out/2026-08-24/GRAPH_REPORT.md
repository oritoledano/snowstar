...
## Corpus Check
- 53 files · ~337,029 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 570 nodes · 1337 edges · 36 communities (28 shown, 8 thin omitted)
...
- `password_resets` --references--> `users`  [EXTRACTED]
  worker/schema-account.sql → worker/schema.sql
- `handleTrack()` --calls--> `currentUser()`  [EXTRACTED]
  worker/src/analytics.js → worker/src/session.js
...
Cohesion: 0.06
Nodes (77): addChannel(), allChannels(), clean(), json(), listChannels(), now(), PLATFORMS, removeChannel() (+69 more)

### Community 1 - "mutra-page.js"
Cohesion: 0.08
Nodes (62): addCurateControls(), appendPage(), applyOverrides(), clearFilters(), closeDrawer(), closePlayer(), cycle(), drawDrop() (+54 more)
...
- **Why does `handle()` connect `index.js` to `analytics.js`, `licensing.js`, `oauth.js`, `bulk.js`, `hyp.js`, `rights.js`, `stream.js`, `artistreg.js`?**
