...
## Corpus Check
- 76 files · ~409,976 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 934 nodes · 2237 edges · 55 communities (53 shown, 2 thin omitted)
...
### Community 40 - "artists.js"
Cohesion: 0.26
Nodes (13): AUDIO_EXT, json(), listArtistsAdmin(), listSubmissions(), myUploads(), now(), queueReviewMail(), registerArtist() (+5 more)
