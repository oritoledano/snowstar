...
## Corpus Check
- 66 files · ~352,109 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 815 nodes · 1938 edges · 47 communities (45 shown, 2 thin omitted)
...
Cohesion: 0.09
Nodes (44): alert(), accrueEarnings(), ARTIST_SHARE_BP, json(), listEarnings(), myEarnings(), now(), settleEarnings() (+36 more)
