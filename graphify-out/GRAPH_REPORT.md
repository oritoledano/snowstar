...
## Corpus Check
- 60 files · ~356,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 763 nodes · 1809 edges · 43 communities (41 shown, 2 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9001a2cc`
...
Cohesion: 0.12
Nodes (31): alert(), ALERT_KINDS, alertsMuted(), handleDownload(), handleJourney(), handleStats(), handleTrack(), json() (+23 more)
...
Cohesion: 0.19
Nodes (29): commitReview(), gate(), gauge(), load(), openDeclEditor(), openMember(), openReviewNote(), paint() (+21 more)
...
### Community 35 - "catalog.js"
Cohesion: 0.30
Nodes (13): clean(), json(), LIST_FIELDS, listOrigTitles(), listOverrides(), listUses(), now(), sanitize() (+5 more)

### Community 36 - "mutra-artist-panel.js"
Cohesion: 0.44
Nodes (8): albumsOf(), build(), close(), loadRoster(), open(), paint(), socialHtml(), tracksBy()

### Community 37 - "artists.js"
Cohesion: 0.28
Nodes (12): AUDIO_EXT, json(), listArtistsAdmin(), listSubmissions(), myUploads(), now(), queueReviewMail(), registerArtist() (+4 more)

### Community 38 - "clearlist.js"
Cohesion: 0.42
Nodes (9): addChannel(), allChannels(), clean(), json(), listChannels(), now(), PLATFORMS, removeChannel() (+1 more)

### Community 39 - "contact.js"
Cohesion: 0.44
Nodes (8): clean(), json(), listMessages(), makeRef(), now(), ROUTES, setMessageStatus(), submitContact()

### Community 40 - "artistreg.js"
Cohesion: 0.62
Nodes (6): ensureArtists(), json(), listArtists(), now(), saveArtist(), splitNames()

### Community 41 - "Four services section"
Cohesion: 0.40
Nodes (5): Audio Branding service, Original Music service, Post Sound / SFX service, Four services section, SoundScapes service

### Community 42 - "Portfolio years — what still needs your eye"
Cohesion: 0.40
Nodes (4): Leads — a likely year, but not one I would print, No price offer found — likely needs the Gmail search, Portfolio years — what still needs your eye, Your own artist work — no offer exists by definition

## Knowledge Gaps
- **88 isolated node(s):** `SHOWREEL`, `PROJECTS`, `CLIENT_LOGOS`, `nav`, `menuBtn` (+83 more)
