...
## Corpus Check
- 61 files · ~344,374 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 778 nodes · 1838 edges · 43 communities (41 shown, 2 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `689d63fa`
...
Cohesion: 0.27
Nodes (17): b64url(), bounce(), claimHandoff(), enc, finishOAuth(), issueSession(), KILL_LEGACY_COOKIE, linkAndSignIn() (+9 more)
...
Cohesion: 0.14
Nodes (31): cleanupOrphanUploads(), randB64(), ALLOWED_ORIGINS, authed(), clearThrottle(), favoritesFor(), fetch(), handle() (+23 more)
...
### Community 35 - "profile.js"
Cohesion: 0.29
Nodes (11): clean(), clearAvatar(), FIELD_COLS, IMG_EXT, json(), myDownloads(), myFavoritesList(), now() (+3 more)
...
## Knowledge Gaps
- **91 isolated node(s):** `SHOWREEL`, `PROJECTS`, `CLIENT_LOGOS`, `nav`, `menuBtn` (+86 more)
