...
## Corpus Check
- 58 files · ~348,803 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 731 nodes · 1729 edges · 34 communities (32 shown, 2 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 87 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36c4feea`
...
## Knowledge Gaps
- **84 isolated node(s):** `SHOWREEL`, `PROJECTS`, `CLIENT_LOGOS`, `nav`, `menuBtn` (+79 more)
